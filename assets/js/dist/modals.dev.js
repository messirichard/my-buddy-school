...
function (_HTMLElement) {
  _inherits(ModalsTake, _HTMLElement);

  function ModalsTake() {
    _classCallCheck(this, ModalsTake);

    return _possibleConstructorReturn(this, _getPrototypeOf(ModalsTake).apply(this, arguments));
  }

  _createClass(ModalsTake, [{
...
function (_HTMLElement2) {
  _inherits(ModalsQuit, _HTMLElement2);

  function ModalsQuit() {
    _classCallCheck(this, ModalsQuit);

    return _possibleConstructorReturn(this, _getPrototypeOf(ModalsQuit).apply(this, arguments));
  }

  _createClass(ModalsQuit, [{
    key: "connectedCallback",
    value: function connectedCallback() {
